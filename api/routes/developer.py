...
VECTOR_CACHE_DIR = os.path.join(os.path.dirname(os.path.dirname(__file__)), "vector_cache")
...
async def save_flow(request: SaveFlowRequest):
    """
    Save a flow to the file system.
    """
    try:
...
async def get_vectors(request: GetVectorsRequest):
    """
