...
echo -e "- Minimal Test: ${YELLOW}$DEPLOYMENT_URL/minimal-test${NC}"
echo ""
...
echo ""
echo -e "${BLUE}Minimal Test Endpoints:${NC}"
echo -e "- Environment Info: ${YELLOW}$DEPLOYMENT_URL/minimal-test/environment${NC}"
echo -e "- System Path: ${YELLOW}$DEPLOYMENT_URL/minimal-test/sys-path${NC}"
echo ""
